...
# Abstract
Hybrid solvers for combinatorial optimization problems combine the advantages of
classical and quantum computing to overcome difficult computational challenges.
...
that enables users to easily adapt and configure hybrid solvers via Meta-Solver
strategies.
...
its architecture, and demonstrates possible applications for several real-world
use cases.
